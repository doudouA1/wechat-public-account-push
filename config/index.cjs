...
const USER_CONFIG = {
  ...
  // 使用微信测试号：公众号APP_ID
  APP_ID: 'wxfdb73ddfc3a0835d',

  // 使用微信测试号：公众号APP_SECRET
  APP_SECRET: '9bebd3eaae342403c577ba44eae504b7',
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '周小静', year: '2001', date: '09-20',
        },
  ...
  CALLBACK_TEMPLATE_ID: 'YlrbJKueG2or5GC8NtRCLCVKPAgxAKL8JPZUfv2IGLI',
